...
export default function main(state = {isLoading: true, authenticated: false, isDesktop: true, breadcrumbs: []}, action) {
	switch (action.type) {
		case CONSTANTS.SET_AUTHENTICATED: return Object.assign({}, state, {authenticated: action.payload});
