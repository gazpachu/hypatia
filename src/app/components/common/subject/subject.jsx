...
class Subject extends Component {
	...
	render() {
		...
		if (isLoaded(this.props.subject) && isLoaded(this.props.files) &&
			isLoaded(this.props.users) && !isEmpty(this.props.subject) &&
			!isEmpty(this.props.files) && !isEmpty(this.props.users)) {
				...
				{subject ? <div className="page-wrapper">
					...
					<div className="meta">
						...
						{isLoaded(this.props.userData) && !isEmpty(this.props.userData) &&
							this.props.userData.info.level >= CONSTANTS.ADMIN_LEVEL ?
					...
					<ul className="horizontal-nav">
						...
						<li className={classNames('horizontal-nav-item', { active: section === 'modules', hidden: !modules })}>
							<Link to={`/subjects/${subject.slug}/modules`}>Modules</Link>
						</li>
						<li className={classNames('horizontal-nav-item', { active: section === 'activities', hidden: !activities })}>
