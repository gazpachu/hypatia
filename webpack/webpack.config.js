...
module.exports = (options) => {
			...
			loaders: [
				{
					...
					test: /\.svg$/,
					loader: `svg-sprite?${JSON.stringify({ name: '[name]_[hash]', prefixize: true })}`
				}
			]
		},
	...
	if (options.isProduction) {
		...
		webpackConfig.plugins.push(new Webpack.optimize.OccurenceOrderPlugin(), new CopyWebpackPlugin([
			{
				from: 'static',
				to: 'static'
			}, {
